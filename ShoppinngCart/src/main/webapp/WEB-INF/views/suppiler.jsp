  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="./ak" style="background-color:#1E90FF;" class="glyphicon glyphicon-home"><b> HOME </b></a></li>
...
<h2>Add a Suppiler</h2>
    ...
    <c:url var="suppiler" value="suppiler"></c:url>
   <form:form commandName="Suppiler" method="post" action="storesupplier">
       <table class="table table-bordered" >
           ...
           <tr><td><form:label path="productname">Product Name :</form:label></td>
             ...
             <td><input type="submit" value="Add Suppiler" class="btn-primary"/></td>
       </table>
   </form:form> 
   </div>
