  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="home" style="background-color:#1E90FF;" class="glyphicon glyphicon-home"> HOME</a></li>
	   ...
	   <li class="active">   <a href="logout"  style="background-color:#1E90FF;" class="glyphicon glyphicon-log-out" ><b> LOGOUT </b></a>
	   </li>
...
<div ng-app="myApp" ng-controller="customersCtrl">
 ...
 <!-- <a href="viewproducts" class="btn btn-success pull-right"><span class="glyphicon glyphicon-shopping-cart"></span> Check out</a> -->
